...
export const parameterDescriptions = {
  ...
  mwUsername: 'MediaWiki username (for private wikis)',
  mwPassword: 'MediaWiki user password (for private wikis)',
  ...
  speed: 'Number of parallel HTTP workers (default: 1). Increase to speed up scraping on capable MediaWiki instances.',
  verbose:
  ...
  forceSkin: 'Force the usage of a skin (must be available on wiki), default skin automatically chosen otherwise',
